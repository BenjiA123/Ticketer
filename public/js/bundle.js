...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGVja3dybGQiLCJhIjoiY2tmdTIxNHgwMHB4YTJ3bWo5OTlzM2p6YiJ9.MOEwWtbYice6wS6JUeYiYg';
...
var stripe = Stripe('pk_test_51HcFuQD88wUJ9rzciF5ESyngbDa7swRheC3fckddEH6rk2XtF3GQjz24WU943bQrU8cnc4rk3WFbEZWDBNaPCvYW00m1msyuuF');
...
var mapBox = document.getElementById('map'); // const mapBox = JSON.parse(document.getElementById('map').dataset.locations);
...
if (updateInfoForm) {
  ...
  updateInfoForm.addEventListener('submit', function (e) {
    ...
    console.log(frm);
    (0, _updateSettings.updateSettings)(frm, 'data');
  });
}
